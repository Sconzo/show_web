        ...
        <div className="block-question">
          ...
          {question.type === "MULTIPLE_CHOICE" ? (
            <div className="option-block">
              <div
                className={
                  question.options[0].correctOption
                    ? "circle-green"
                    : "circle-red"
                }
              ></div>
              ...
              <div
                className={
                  question.options[1].correctOption
                    ? "circle-green"
                    : "circle-red"
                }
              ></div>
              ...
              <div
                className={
                  question.options[2].correctOption
                    ? "circle-green"
                    : "circle-red"
                }
              ></div>
              ...
              <div
                className={
                  question.options[3].correctOption
                    ? "circle-green"
                    : "circle-red"
                }
              ></div>
